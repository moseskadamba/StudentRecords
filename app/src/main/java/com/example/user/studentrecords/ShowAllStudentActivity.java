package com.example.user.studentrecords;
...
public class ShowAllStudentActivity extends AppCompatActivity {
    ...
    String HttpUrl = "http://mkadamba.hostingerapp.com/AllStudentData.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new GetHttpResponse(ShowAllStudentActivity.this).execute();
        ...
        StudentListView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ShowAllStudentActivity.this,ShowSingleRecordActivity.class);
